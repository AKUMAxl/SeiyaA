...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(List<String> dataList, Context context, DecorationCallback decorationCallback) {
        ...
        textPaint.setColor(res.getColor(R.color.white));
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            float textY = Math.max(2*topGap, view.getTop());
            //下一个和当前不一样移动当前
            ...
            c.drawRect(left, textY - 2*topGap, right, textY, paint);
